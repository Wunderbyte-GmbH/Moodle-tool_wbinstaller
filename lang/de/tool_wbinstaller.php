...
$string['simulationfilefound'] = 'Simulationsdatei gefunden.';
$string['simulationinstallerfilefound'] = 'Simulations-Installer gefunden: {$a}.';
$string['simulationinstallersuccess'] = 'Der angegebene Installer {$a} wurde gefunden und verwendet.';
$string['simulationnoinstallerfilefound'] = 'Installer {$a} wurde nicht gefunden. Wenn der Installer in diesem Rezept enthalten ist, werden die Daten normal installiert.';
$string['simulationnoinstallerfilefoundexecute'] = 'Installer {$a} wurde nicht gefunden und die Installation wurde nicht ausgeführt.';
...
$string['vuesimulationsheading'] = 'Simulationen im ZIP:';
