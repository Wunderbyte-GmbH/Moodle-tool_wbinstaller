...
$string['categoriescreated'] = 'Kategorie erstellt: {$a}.';
...
$string['filesystemcopyok'] = 'Dateien kopiert von {$a->from} nach {$a->to}.';
$string['filesystemcopyskip'] = 'Quelldateiordner nicht gefunden: {$a}.';
$string['filesystemcopyfailed'] = 'Kopieren der Dateien von {$a->from} nach {$a->to} fehlgeschlagen.';
$string['filesystemdeleteok'] = 'Pfad gelöscht: {$a}.';
$string['filesystemdeleteskip'] = 'Pfad zum Löschen nicht gefunden: {$a}.';
$string['filesystemdeletefailed'] = 'Löschen des Pfads fehlgeschlagen: {$a}.';
$string['filesystemdircreated'] = 'Verzeichnis erstellt: {$a}.';
$string['filesystemdirexists'] = 'Verzeichnis existiert bereits: {$a}.';
$string['filesystemdirfailed'] = 'Verzeichnis konnte nicht erstellt werden: {$a}.';
$string['filesystemmoveok'] = 'Dateien verschoben von {$a->from} nach {$a->to}.';
$string['filesystemmoveskip'] = 'Quellpfad zum Verschieben nicht gefunden: {$a}.';
$string['filesystemmovefailed'] = 'Verschieben der Dateien von {$a->from} nach {$a->to} fehlgeschlagen.';
$string['filesystemrepoenabled'] = 'Dateisystem-Repository aktiviert.';
...
$string['profilefieldcreated'] = 'Profilfeld {$a} erstellt.';
$string['profilefieldexists'] = 'Profilfeld existiert bereits: {$a}.';
$string['profilefieldmissing'] = 'Profilfeld fehlt: {$a}.';
$string['profilefieldunsupported'] = 'Profilfeldtyp {$a} wird nicht unterstützt.';
