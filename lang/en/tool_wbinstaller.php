...
$string['categoriescreated'] = 'Created category {$a}.';
$string['categoriesexists'] = 'Category already exists: {$a}.';
$string['categoriesfound'] = 'Category path found: {$a}.';
$string['categoriesmissing'] = 'Category path missing at: {$a}.';
$string['checkreturnednull'] = 'An error orrcured in install step {$a}.
    This may be because the JSON or CSV files in the corresponding directory
...
$string['csvinvalidheaders'] = 'The CSV file {$a} does not posess of sufficient header.';
$string['csvmissingfields'] = 'Missing data in line {$a->line} in CSV file {$a->file} skipped.';
$string['csvnotreadable'] = 'CSV file {$a} not readabler.';
...
$string['filesystemcopyfailed'] = 'Failed to copy files from {$a->from} to {$a->to}.';
$string['filesystemcopyok'] = 'Copied files from {$a->from} to {$a->to}.';
$string['filesystemcopyskip'] = 'Source directory not found: {$a}.';
$string['filesystemdeletefailed'] = 'Failed to delete path: {$a}.';
$string['filesystemdeleteok'] = 'Deleted path: {$a}.';
$string['filesystemdeleteskip'] = 'Path not found for deletion: {$a}.';
$string['filesystemdircreated'] = 'Created directory: {$a}.';
$string['filesystemdirexists'] = 'Directory already exists: {$a}.';
$string['filesystemdirfailed'] = 'Failed to create directory: {$a}.';
$string['filesystemmovefailed'] = 'Failed to move files from {$a->from} to {$a->to}.';
$string['filesystemmoveok'] = 'Moved files from {$a->from} to {$a->to}.';
$string['filesystemmoveskip'] = 'Source path not found for move: {$a}.';
$string['filesystemrepoenabled'] = 'Filesystem repository enabled.';
...
$string['profilefieldcreated'] = 'Profile field {$a} created.';
$string['profilefieldexists'] = 'Profile field already exists: {$a}.';
$string['profilefieldmissing'] = 'Profile field missing: {$a}.';
$string['profilefieldunsupported'] = 'Profile field type {$a} is not supported.';
